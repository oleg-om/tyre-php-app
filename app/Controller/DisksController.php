                        ...
                        foreach ($v3 as $key4 => $v1):$i++;
                            if ($i >= 20000 && $i < 25000):
                                ...
                                <tr>
                                    ...
                                    <td valign="top" align="left"><?php echo $otchet;//echo$key4;
                                        ?></td>
                                </tr>
                            <?php
                            endif;endforeach;
                    ...
                    foreach ($th3 as $val3):
                        ...
                        foreach ($th4 as $val4):?>
                            <tr>
                                ...
                                <td valign="top"
                                    align="center"><?php echo $val3['car_modifications']['title'];//echo$val4['car']['title'];
                                    ?><?php //echo iconv('windows-1251','utf-8',$val4['arr4']); //echo$val4['arr4'];//echo$key4;
                                    ?></td>
                    ...
                    foreach ($val2 as $key3 => $val3):if ($i < $t_k):
                        foreach ($val3 as $key4 => $val4):$i++;
                            if ($i >= $t_n && $i < $t_k):
                                ...
                                <tr>
                                    <td valign="top" align="center"><?php echo $i; ?></td>
                                    <td valign="top" align="center"><?php echo $val4['arr1'];//echo$key1;
                                        ?></td>
                                    <td valign="top" align="center"><?php echo $val4['arr2']; //echo$key2;
                                        ?></td>
                                    <td valign="top"
                                        align="center"><?php echo iconv('windows-1251', 'utf-8', $val4['arr3']); //echo$key3;
                                        ?></td>
                                    <td valign="top"
                                        align="center"><?php echo iconv('windows-1251', 'utf-8', $val4['arr4']); //echo$val4['arr4'];//echo$key4;
                                        ?></td>
