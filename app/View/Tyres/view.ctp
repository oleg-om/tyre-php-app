...
<div class="product__wrapper">
    ...
    <div class="infoProdBig">
        <div class="boxLeftInfo">
            ...
            <div class="tableProd">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th>Типоразмер</th>
                        <td><?php echo $product['Product']['size1']; ?> / <?php echo $product['Product']['size2']; ?>
                            R<?php echo $product['Product']['size3']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>RUN FLAT</th>
                        <td><?php if ($product['Product']['p5'] == 1) {
                                echo 'Да';
                            } else {
                                echo 'Нет';
                            } ?></td>
                    ...
                    <tr>
                        <th>XL (Extra Load)</th>
                        <td><?php if ($product['Product']['p4'] == 1) {
                                echo 'Да';
                            } else {
                                echo 'Нет';
                            } ?></td>
        ...
        <div class="boxRightInfo">
            ...
            <?php } ?>
            <?php echo $this->element('tyre_benefit', array('product' => $product['Product'])); ?>
            <div class="orderCall">
        ...
        <div class="textProd">
            ...
            <?php } ?>
            <?php if (!empty($product['BrandModel']['video'])) { ?>
                <div class="video"><?php echo $product['BrandModel']['video']; ?></div><?php } ?>
        </div>
    </div>
</div>
