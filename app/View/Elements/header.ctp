            ...
            <div id="nav" class="toggle__menu">
                <ul>
                    ...
                    <li<?php if ($active_menu == 'home') { ?> class="activ" <?php } ?>><a href="/">Главная</a></li>
                        <li<?php if ($active_menu == 'tyres') { ?> class="activ" <?php } ?>><a href="/tyres<?php if (!empty($modification)) {
                                    echo '?modification=' . $modification;
                                } else {
                                    echo CONST_DEFAULT_TYRES_PATH;
                                } ?>">Шины</a>
                            </li>
                            <li<?php if ($active_menu == 'disks') { ?> class="activ" <?php } ?>><a href="/disks<?php if (!empty($modification)) {
                                        echo '?modification=' . $modification;
                                    } else {
                                        echo CONST_DEFAULT_DISKS_PATH;
                                    } ?>">Диски</a>
                                </li>
                                <li<?php if ($active_menu == 'akb') { ?> class="activ" <?php } ?>><a href="/akb<?php if (!empty($modification)) {
                                            echo '?modification=' . $modification;
                                        } else {
