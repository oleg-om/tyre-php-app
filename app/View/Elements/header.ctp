		...
		<div class="wrap header-wrapper">
			...
			<div id="nav" class="toggle__menu">
				<ul>
					...
					<li<?php if ($active_menu == 'tyres') { ?> class="activ"<?php } ?>><a href="/tyres<?php if (!empty($modification_slug) && $active_menu != 'tyres') { echo '?modification='.$modification_slug; } else { echo '?size1=205&size2=55&size3=16'; } ?>">Шины</a></li>
					<li<?php if ($active_menu == 'disks') { ?> class="activ"<?php } ?>><a href="/disks<?php if (!empty($modification_slug) && $active_menu != 'disks') { echo '?modification='.$modification_slug; } else { echo '?size1=18'; } ?>">Диски</a></li>
					<li<?php if ($active_menu == 'akb') { ?> class="activ"<?php } ?>><a href="/akb<?php if (!empty($modification_slug) && $active_menu != 'akb') { echo '?modification='.$modification_slug; } else { echo '?ah=60'; } ?>">АКБ</a></li>
