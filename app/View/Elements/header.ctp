		...
		<div class="wrap header-wrapper">
			...
			<div id="nav" class="toggle__menu">
				<ul>
					...
					<li<?php if ($active_menu == 'truck-tyres' || $active_menu == 'truck-wheels') { ?> class="activ"<?php } ?>><a href="/tyres?auto=trucks&in_stock4=0&in_stock=2&upr_all=1">Грузовые авто</a></li>
