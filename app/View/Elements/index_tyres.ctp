                        ...
                        <?php if ($mode == 'table' || count($item['Product']) == 1) { ?>
                                ...
                                <div class="box-info">
                                            ...
                                            <?php if ($show_size || $has_params) { ?>
                                                <div class="detalProd tyres">
                                                    <a href="<?php echo Router::url($url); ?>"><?php
                                                        ...
                                                        R<?php echo $item['Product'][0]['size3']; ?> <?php echo h($item['Product'][0]['f1'] . $item['Product'][0]['f2']);
                                                        ?></a>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="product__info">
                                        ...
                                        <div class="buy-button">
                                            <a href="javascript:void(0);" class="btVer2"
                                               onclick="buy_tyre(<?php echo $item['Product'][0]['id']; ?>);">Купить</a>
                                        </div>
                                    </div>
                            ...
                            <?php } elseif ($mode == 'list') { ?>
                                ...
                                <div class="infoList2">
                                    ...
                                    <table cellpadding="0" cellspacing="0" class="table-box-list">
                                        <col width="180">
                                        <col width="50">
                                        <col width="231" class="desc-col">
                                        <col width="16">
                                        <col width="61" class="desc-col">
                                        <col width="171">
                                        <col class="desc-col"/>
                                        ...
                                        <tr onclick="window.location='<?php echo Router::url(array('controller' => 'tyres', 'action' => 'view', 'slug' => $item['Brand']['slug'], 'id' => $item['Product'][0]['id'], '?' => $filter)); ?>';">
                                            <td><?php
                                                echo $item['Product'][0]['size1']; ?>
                                                / <?php echo $item['Product'][0]['size2']; ?>
                                                R<?php echo $item['Product'][0]['size3'];
                                                ?></td>
                                            <td><?php echo h($item['Product'][0]['f1'] . $item['Product'][0]['f2']); ?></td>
                                            <td class="desc-table"><?php echo $this->Frontend->getFF($item['Product'][0]['f1'], $item['Product'][0]['f2']); ?></td>
                                            <td>
                                                <div class="productSeason<?php if ($season == 'winter') {
                                                    echo '2';
                                                } elseif ($season == 'all') {
                                            ...
                                            <td><strong><?php
                                                    ...
                                                    ?></strong></td>
                                            <td class="desc-table"><?php if ($item['Product'][0]['sale']) { ?>
                                                    <div class="action-prod-list"><span>акция</span></div><?php } ?>
                                            </td>
                                            <td class="desc-table"><?php echo $this->Frontend->getStockCount($item['Product'][0]['stock_count']); ?>
                                                шт.
                                            </td>
                            ...
                            <?php } else { ?>
                                ...
                                <tr class="no-more-info season-<?php echo $season; ?> <?php echo $class; ?> season-<?php echo isset($item['Product'][0]) ? 'yes' : 'no'; ?> season-<?php echo $is_trucks ? 'trucks' : 'cars'; ?>"
                                    ...
                                    <td><?php echo $this->Frontend->getStockCount($item['Product'][0]['stock_count']); ?>
                                        шт.
                                    </td>
                            ...
                            <?php if ($mode == 'block') {
                                ...
                                <div class="box-info">
                                    ...
                                    <div class="infoList">
                                        ...
                                        <?php if (!$has_params) { ?>
                                            ...
                                            <?php if (isset($item['Product'][0])) { ?>
                                                <div class="stud"><?php echo $item['Product'][0]['stud'] ? '<img src="/img/icons/studded.png" alt="шипованная" />' : ''; ?></div>
                                            <?php } ?>
                                        <?php } ?>
                                        <?php if ($has_params) { ?>
                                            <div class="detalProd">
                                    ...
                                    <div class="priceMore priceMore-range">
                                        <?php if ($this->Frontend->canShowTyrePrice($item['Product'][0]['auto'], $item['Product'][0]['not_show_price']) && ($show_size || $has_params)) { ?>
                                            <em>от</em>
                                            <span><?php echo $this->Frontend->getPrice($min_price, 'tyres', array('between' => '&nbsp;<span>', 'after' => '</span>')); ?></span>
                                        <?php } ?>
                                    ...
                                    <table cellpadding="0" cellspacing="0" class="table-box-list">
                                        ...
                                        <?php foreach ($item['Product'] as $product) { ?>
                                            ...
                                            <tr onclick="window.location='<?php echo Router::url(array('controller' => 'tyres', 'action' => 'view', 'slug' => $item['Brand']['slug'], 'id' => $product['id'])); ?>'">
                                                ...
                                                <td class="desc-table"><?php echo $this->Frontend->getFF($product['f1'], $product['f2']); ?></td>
                                                <td>
                                                    <div class="productSeason<?php if ($season == 'winter') {
                                                        echo '2';
                                                    } elseif ($season == 'all') {
                                                ...
                                                <td class="desc-table"><?php echo $this->Frontend->getStockCount($product['stock_count']); ?>
                                                    шт.
                                                </td>
                            ...
                            <?php } else { ?>
                                <?php foreach ($item['Product'] as $product) { ?>
                                    ...
                                    <tr class="no-more-info season-<?php echo $season; ?> <?php echo $class; ?> season-<?php echo isset($item['Product'][0]) ? 'yes' : 'no'; ?> season-<?php echo $is_trucks ? 'trucks' : 'cars'; ?>"
                                        ...
                                        <td><?php echo $product['stud'] ? '<img src="/img/icons/studded.png" alt="шиповання" />' : ''; ?></td>
                                        <td><?php echo $this->Frontend->getStockCount($product['stock_count']); ?>шт.
                                        </td>
                                        <td class="price"><strong><?php
                                                if ($this->Frontend->canShowTyrePrice($product['auto'], $product['not_show_price'])) {
