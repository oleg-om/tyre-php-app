                    ...
                    <div class="list-view__item akb">
                        <div class="list-view__info-col">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $item['Product']['width'].' x '.$item['Product']['length'].' x '.$item['Product']['height'].' мм'; ?></td>
                                </tr>
                                <tr>
                                    <th>Технология изготовления</th>
                                    <td><?php echo $item['Product']['manufacturing_technology'] ? $item['Product']['manufacturing_technology'] : '-'; ?></td>
                                </tr>
                                <tr>
                                    <th>Страна-производитель</th>
                                    <td><?php echo $item['Product']['country'] ? $item['Product']['country'] : '-'; ?></td>
                                </tr>
                            </table>
                        ...
                        <div class="list-view__price-col">
                            <div class="product__info-prices">
                                <?php if ($this->Frontend->canShowAkbPrice(false)) { ?>
                                    <?php if ($this->Frontend->canShowAkbPrice($item['Product']['not_show_price'])) { ?>
                                            <?php if ($item['Product']['price_with_exchange'])  { ?>
                            ...
                            <div class="product__info-instock">
                                <div class="namber tyres"><?php echo 'В наличии: '.$this->Frontend->getStockCount($item['Product']['stock_count']); ?> шт. <?php echo $item['Product']['in_stock'] ? '<img title="в наличии" alt="в наличии" src="/img/yes.png">' : ''; ?></div>
                                <td><?php echo $item['Product']['in_stock'] ? '.' : ''; ?></td>
                            </div>
                        </div>
                    </div>
